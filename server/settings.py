...
DATABASES = {
    'default': {
        ...
        'NAME': 'tex.db',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = '/Users/jainbasil/Desktop/live-latex/server/media/'
...
STATIC_ROOT = '/Users/jainbasil/Desktop/live-latex/server/static/'
...
SECRET_KEY = 'axaqkcz@f(%k$-9=1o8x*z1icxdoq7bp*=83+f_@gizd$stiu3'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
	"/Users/jainbasil/Desktop/live-latex/server/templates",
)
